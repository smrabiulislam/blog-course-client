    ...
    return (
        <div>
            ...
            <div className='container mx-auto flex justify-around my-10'>
                <div>
                    <ComputerDesktopIcon className="hover:bg-slate-200 rounded-full hover:p-3  h-12 hover:text-violet-600 text-blue-500"></ComputerDesktopIcon>
                    <h2>Personal Computer</h2>
                </div>
                <div >
                    <LanguageIcon className="hover:bg-slate-200 rounded-full hover:p-3  h-12 hover:text-violet-600 text-blue-500"></LanguageIcon>
                    <h2>Sign Language</h2>
                </div>
                <div >
                    <AcademicCapIcon className="hover:bg-slate-200 rounded-full hover:p-3  h-12 hover:text-violet-600 text-blue-500"></AcademicCapIcon>
                    <h2>Academic</h2>
                </div>
                <div >
                    <DevicePhoneMobileIcon className="hover:bg-slate-200 rounded-full hover:p-3  h-12 hover:text-violet-600 text-blue-500"></DevicePhoneMobileIcon>
                    <h2>Auto Mobile</h2>
                </div>
            </div>
        </div>
